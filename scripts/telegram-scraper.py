...
DEFAULT_CHANNEL_DELAY = 5.0
DEFAULT_MESSAGE_DELAY = 3.0
    ...
    while True:
        try:
            ...
            async for message in client.iter_messages(entity, limit=limit):
                try:
                    ...
                    if message_delay and message_delay > 0:
                     ...
                     # skip this single message and continue with the next one
                    continue
                
            # Save all messages to JSON file for this channel + date    
            ...
            if retries > max_retries:
                ...
                return 0
        #this is the channel wide exception handler if fails it skips the entire channel
        except Exception as e:
